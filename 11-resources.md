...
|---|---|
| [ISTQB CTFL Syllabus](https://www.istqb.org/certifications/certified-tester-foundation-level) (free PDF) | THE standard vocabulary & concepts — read it even if you skip the exam 💰(exam only) |
| [ISTQB Glossary](https://glossary.istqb.org/) | Settle any terminology debate in seconds |
| [ISO/IEC/IEEE 29119](https://en.wikipedia.org/wiki/ISO/IEC_29119) (overview) | Know it exists; enterprises reference it |
...
| Source | What you get |
|---|---|
| [Ministry of Testing](https://www.ministryoftesting.com/) | The QA community hub — articles, The Club forum, TestBash talks (some 💰) |
| [Test Automation University](https://testautomationu.applitools.com/) | Completely free structured courses, manual → automation, with certificates |
| [Satisfice blog (James Bach)](https://www.satisfice.com/blog) | Rapid Software Testing school — sharpens your thinking |
| [DevelopSense (Michael Bolton)](https://developsense.com/blog) | Testing vs checking, deep craft essays |
| [Guru99 Software Testing](https://www.guru99.com/software-testing.html) | Beginner-friendly walkthroughs of every concept |
| [Software Testing Help](https://www.softwaretestinghelp.com/) | Tutorials + tool comparisons |
| [BrowserStack Guide Hub](https://www.browserstack.com/guide) | Practical cross-browser/mobile testing guides |
| [Kaner's testing courses (BBST)](https://testingeducation.org/BBST/) | Free university-grade testing course materials |
| [MDN Web Docs](https://developer.mozilla.org/) | When you need to understand how the web actually works |

## 🧪 Practice targets — safe places to test for real

| Target | Practice |
|---|---|
| [the-internet.herokuapp.com](https://the-internet.herokuapp.com/) | Every tricky UI element: iframes, dynamic loads, auth, uploads |
| [saucedemo.com](https://www.saucedemo.com/) | A full mock store — perfect for your portfolio test suite |
| [automationexercise.com](https://automationexercise.com/) | E-commerce with signup/cart/checkout flows + API list |
| [DemoQA](https://demoqa.com/) | Forms, widgets, interactions |
| [OWASP Juice Shop](https://owasp.org/www-project-juice-shop/) | Deliberately vulnerable app — security testing playground |
| [restful-booker](https://restful-booker.herokuapp.com/apidoc/index.html) | An API built to be tested with Postman — auth, CRUD, bugs included |
| [ReqRes](https://reqres.in/) & [JSONPlaceholder](https://jsonplaceholder.typicode.com/) | Instant fake APIs for request practice |
| [Postman Learning Center](https://learning.postman.com/) | Official API-testing curriculum |
| [uTest](https://www.utest.com/) / [Testlio](https://testlio.com/) | Paid crowdtesting — real experience while job hunting |

## 🎥 Watch & listen

| Source | Format |
|---|---|
| [Ministry of Testing YouTube](https://www.youtube.com/@MinistryofTesting) | Conference talks — watch one TestBash talk weekly |
| [Test Guild podcast (Joe Colantonio)](https://testguild.com/podcasts/) | Weekly automation & QA interviews |
| [AB Testing podcast](https://www.angryweasel.com/ABTesting/) | Alan Page & Brent Jensen — modern quality thinking |
| [Testing Peers](https://testingpeers.com/) | QA leadership & career conversations |
| [AZADEMY](https://www.youtube.com/@azademy) | My channel — practical QA/tech careers, real interview content, learning-meets-earning |

## 📬 Stay current

- [Software Testing Weekly](https://softwaretestingweekly.com/) — the one newsletter to subscribe to
