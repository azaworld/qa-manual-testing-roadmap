...
<p>
  ...
  <img src="https://img.shields.io/badge/experience-6%2B%20years-22d3ee?style=flat-square" />
...
Follow the stages in order. Each stage links to a full chapter with worked examples.
...
| **3** | [Types of Testing](04-types-of-testing.md) | Know every kind of testing, when to use each, and how to run it manually |
| **4** | [QA in Agile Teams](05-agile-and-process.md) | Work a real sprint: defect lifecycle, severity vs priority, release gates, QA metrics |
